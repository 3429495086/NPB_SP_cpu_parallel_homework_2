...
/* common /fields/ */
#pragma dvm template [KMAX+2][JMAX+2][IMAX+2] distribute [block][block][block]
void *tmp;

#pragma dvm array align ([k][j][i][] with tmp[k][j][i]) shadow[2][2][2][0]
double u      [KMAX+1][JMAXP+1][IMAXP+1][5];
#pragma dvm array align ([k][j][i] with tmp[k][j][i]) shadow[2][2][2]
double us     [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array align ([k][j][i] with tmp[k][j][i]) shadow[2][2][2]
double vs     [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array align ([k][j][i] with tmp[k][j][i]) shadow[2][2][2]
double ws     [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array align ([k][j][i] with tmp[k][j][i]) shadow[2][2][2]
double qs     [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array align ([k][j][i] with tmp[k][j][i]) shadow[2][2][2]
double rho_i  [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array align ([k][j][i] with tmp[k][j][i]) shadow[2][2][2]
double speed  [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array align ([k][j][i] with tmp[k][j][i]) shadow[2][2][2]
double square [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array align ([k][j][i][] with tmp[k][j][i]) shadow[2][2][2][0]
double rhs    [KMAX+1][JMAXP+1][IMAXP+1][5];
#pragma dvm array align ([k][j][i][] with tmp[k][j][i]) shadow[2][2][2][0]
double forcing[KMAX+1][JMAXP+1][IMAXP+1][5];
...
/* common /work_lhs/ */
#pragma dvm array align ([k][j][i][] with tmp[k][j][i]) shadow[1][1][1][0]
double lhs [KMAXP+1][JMAXP+1][IMAXP+1][5];
#pragma dvm array align ([k][j][i][] with tmp[k][j][i]) shadow[1][1][1][0]
double lhsp[KMAXP+1][JMAXP+1][IMAXP+1][5];
#pragma dvm array align ([k][j][i][] with tmp[k][j][i]) shadow[1][1][1][0]
double lhsm[KMAXP+1][JMAXP+1][IMAXP+1][5];
