...
/* common /fields/ */
#pragma dvm array
extern double u      [KMAX+1][JMAXP+1][IMAXP+1][5];
#pragma dvm array
extern double us     [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array
extern double vs     [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array
extern double ws     [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array
extern double qs     [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array
extern double rho_i  [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array
extern double speed  [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array
extern double square [KMAX+1][JMAXP+1][IMAXP+1];
#pragma dvm array
extern double rhs    [KMAX+1][JMAXP+1][IMAXP+1][5];
#pragma dvm array
extern double forcing[KMAX+1][JMAXP+1][IMAXP+1][5];
...
/* common /work_lhs/ */
#pragma dvm array
extern double lhs [KMAXP+1][JMAXP+1][IMAXP+1][5];
#pragma dvm array
extern double lhsp[KMAXP+1][JMAXP+1][IMAXP+1][5];
#pragma dvm array
extern double lhsm[KMAXP+1][JMAXP+1][IMAXP+1][5];
